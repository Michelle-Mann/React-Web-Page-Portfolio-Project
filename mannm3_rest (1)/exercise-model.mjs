...
// Prepare to the database exercies in the MongoDB server running locally on port 27017
mongoose.connect(
...
/**
 * Replace the name, reps, weights, units adn date of the exercise with the id value 
provided
 * @param {String} name
 * @param {Number} reps 
 * @param {Number} weight 
